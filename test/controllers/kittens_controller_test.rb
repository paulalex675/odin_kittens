...
class KittensControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create kitten" do
    assert_difference('Kitten.count') do
      post kittens_url, params: { kitten: { age: @kitten.age, cutness: @kitten.cutness, integer: @kitten.integer, name: @kitten.name, softness: @kitten.softness } }
    end
  ...
  test "should update kitten" do
    patch kitten_url(@kitten), params: { kitten: { age: @kitten.age, cutness: @kitten.cutness, integer: @kitten.integer, name: @kitten.name, softness: @kitten.softness } }
